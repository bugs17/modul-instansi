"use client"
import { deleteRenstra } from '@/app/actions/delete-renstra'
import { Eye, Trash2 } from 'lucide-react'
import React from 'react'

const ButtonActionRenstra = ({idItem}) => {
    ...
    const handleHapus = async () => {
        ...
        if (res) {
            const result = await deleteRenstra(idItem)
            if (!result) {
...
export default ButtonActionRenstra